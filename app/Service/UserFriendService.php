...
SQL;
     ...
     * @return bool
     */
    public function handleFriendApply(int $uid, int $applyId, $remarks = '')
    {
        /**
     ...
     * @return bool
     */
    public function editFriendRemark(int $uid, int $friendId, string $remarks)
    {
        $data = [];
        if ($uid > $friendId) {
            [$user_id, $friend_id] = [$friendId, $uid];
